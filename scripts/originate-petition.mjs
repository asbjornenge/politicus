...
for (const r of ['IdentityRegistry', 'Variables', 'Treasury', 'ModerationRegistry']) {
...
console.log(`  moderation_registry = ${net.ModerationRegistry}`);
...
const op = await tezos.contract.originate({
  ...
  storage: {
    ...
    moderation_registry: net.ModerationRegistry,
  },
});
